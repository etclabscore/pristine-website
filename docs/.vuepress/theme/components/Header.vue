<template>
  <header class="header-right flex">
    ...
    <div class="menu inline flex flex-center">
      <a href="https://github.com/etclabscore/pristine-website" target="_blank" title="Fork This Page (Github)" class="sm-hide md-hide"><button>Fork This Page</button></a>
      <SearchBox v-if="$site.themeConfig.search !== false"/>
      <a href="https://github.com/etclabscore/pristine-website" target="_blank" title="Fork This Page (Github)" class="md-up-hide">
